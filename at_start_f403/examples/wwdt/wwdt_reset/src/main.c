...
/** @addtogroup 403_WWDT_reset WWDT_reset
  * @{
  */
...
int main(void)
{
  ...
  /* enable wwdt
   ...
   timeout = 64 * (32768 / 120000000 ) = 0.0218s = 21.8ms
   window  = 16 * (32768 / 120000000 ) = 0.0055s = 5.5ms
  ...
  */
  ...
  while(1)
  {
    ...
    /* the reload time must within the window (7ms > 5.5ms) */
    delay_ms(7);
