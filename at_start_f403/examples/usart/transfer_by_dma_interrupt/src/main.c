...
/** @addtogroup 403_USART_transfer_by_dma_interrupt USART_transfer_by_dma_interrupt
  * @{
  */
...
void dma_configuration(void)
{
  ...
  /* dma1 channel6 interrupt nvic init */
  ...
  dma_channel_enable(DMA1_CHANNEL2, TRUE); /* usart3 tx begin dma transmitting */
}
