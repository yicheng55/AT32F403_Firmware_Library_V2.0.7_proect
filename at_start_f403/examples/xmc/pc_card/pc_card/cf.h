...
#define XMC_BANK4_                  (XMC_BASE + 0x30000000)  /*!< XMC Bank4 base address */
...
#define PCCARD_ATTRIBUTE_SPACE_ADDRESS  ((uint32_t)(XMC_BANK4_ + 0x08000000))  /* Attribute space size to @0x9BFF FFFF */
#define PCCARD_IO_SPACE_ADDRESS         ((uint32_t)(XMC_BANK4_ + 0x0C000000))  /* IO space size to @0x9FFF FFFF        */
